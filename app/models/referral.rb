...
class Referral < ActiveRecord::Base
  ...
  def apply_referrer_promotions
    ...
    if referrer.apply_wallet_promotion wallet_promotion
      referrer.notify_wallet "Rs #{wallet_promotion.amount} has been credited to your wallet as referral rewards.We
 hope your friends enjoy their meal!","FreeMeals@Spoonly"
    end
  end
