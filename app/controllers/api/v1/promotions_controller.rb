class Api::V1::PromotionsController < Api::V1::BaseController
  ...
  def referral
    ...
    render json: {show_text: "We currently serve in parts of Hitech City & Gachibowli. Share Spoonly with a
friend and get Rs 50 when they order.", share_text: share_text,referral_code: referral_code}
  end
